...
import '../../../model/post_program_model/post_program_new_model/pp_summary_model.dart';
...
class _PPSummaryScreenState extends State<PPSummaryScreen> {
  ...
  Future getDaySummary() async {
    summaryFuture =
        PostProgramService(repository: repository).getPPDaySummaryService("1");
  }
                            ...
                            return Column(
                              ...
                              children: <Widget>[
                                buildTile(
                                  ...
                                  "Early Morning",
                                  getMorningColor(
                                      data.summary[index].earlyMorning),
                                  () {},
                                ),
                                buildTile(
  ...
  buildTile(String lottie, String title, Color color, VoidCallback func) {
