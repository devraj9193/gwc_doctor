...
class DayTrackerController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    fetchDayTrackerDetails;
  }

  Future<DayTrackerModel>? fetchDayTrackerDetails(String selectedDay) async {
    dynamic res;
    ...
    final response =
    await http.get(Uri.parse("${GwcApi.dayTrackerApiUrl}/$userId/$selectedDay"), headers: {
