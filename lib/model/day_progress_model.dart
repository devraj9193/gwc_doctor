...
class DayProgressModel {
  ...
  factory DayProgressModel.fromJson(Map<String, dynamic> json) => DayProgressModel(
    ...
    detoxDayWiseProgress: List<double>.from(json["detox_day_wise_progress"].map((x) => x.toDouble())),
    healingDayWiseProgress: List<double>.from(json["healing_day_wise_progress"].map((x) => x?.toDouble())),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "detox_day_wise_progress": List<dynamic>.from(detoxDayWiseProgress!.map((x) => x)),
    "healing_day_wise_progress": List<dynamic>.from(healingDayWiseProgress!.map((x) => x)),
  };
}
