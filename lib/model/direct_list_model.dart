...
//
//     final directListModel = directListModelFromJson(jsonString);

import 'dart:convert';

DirectListModel directListModelFromJson(String str) => DirectListModel.fromJson(json.decode(str));

String directListModelToJson(DirectListModel data) => json.encode(data.toJson());
...
class DirectListModel {
  ...
  factory DirectListModel.fromJson(Map<String, dynamic> json) => DirectListModel(
    status: json["status"],
    errorCode: json["errorCode"],
    key: json["key"],
    usersList: List<UsersList>.from(json["users_list"].map((x) => UsersList.fromJson(x))),
  );
