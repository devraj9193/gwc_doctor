...
class MessageScreen extends StatefulWidget {
  ...
  const MessageScreen({Key? key, this.isGroupId = false, required this.userName, required this.profileImage}) : super(key: key);
...
class _MessageScreenState extends State<MessageScreen>
  ...
  bool selectReceivers = false;  final searchController = TextEditingController();
  ...
  Future<List<SuccessTeam>?> fetchSuccessList() async {
    ...
    if (response.statusCode == 200) {
      ...
      successList = successListFromJson(response.body);
      List<SuccessTeam>? arrData = successList?.data;
                    ...
                    if (snapshot.hasError) {
                      ...
                      return Column(
                        ...
                        children: <Widget>[
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              getForwardChatGroupId(data[index].id.toString(),message,data[index].name.toString(),);
                                            },
                                            child: Container(
                                              padding: EdgeInsets.symmetric(
                                                  vertical: 0.5.h,
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                getForwardChatGroupId(searchResults[index].id.toString(),message,searchResults[index].name.toString(),);
                                              },
                                              child: Container(
                                                padding: EdgeInsets.symmetric(
                                                    vertical: 0.5.h,
                          ...
                          (successIdList.isNotEmpty)
                              ? CommonButton.submitButton(() {
                            Navigator.pop(context, successNameList);
                          }, "Submit")
                              : Container(),
                        ],
                      );
  ...
  getForwardChatGroupId(String userId,String message,String userName) async {
  ...
  onSearchTextChanged(String text, StateSetter setState) async {
    ...
    successList?.data?.forEach((userDetail) {
