...
AllCustomerConsultationModel allCustomerConsultationModelFromJson(String str) =>
    AllCustomerConsultationModel.fromJson(json.decode(str));

String allCustomerConsultationModelToJson(AllCustomerConsultationModel data) =>
    json.encode(data.toJson());

class AllCustomerConsultationModel {
  AllCustomerConsultationModel({
    this.status,
    this.errorCode,
  ...
  factory AllCustomerConsultationModel.fromJson(Map<String, dynamic> json) =>
      AllCustomerConsultationModel(
        status: json["status"],
