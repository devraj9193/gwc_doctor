...
//   //     print(
//   //         "_pref!.getString(AppConfig.QB_CURRENT_USERID): ${_pref!.getString(AppConfig.QB_CURRENT_USERID)}");
//   //     _localUserId =
//   //         int.tryParse(_pref!.getString(AppConfig.QB_CURRENT_USERID)!);
//   //   }
//   // }
//   //
//   // @override
...
//   // }
//
//   Future kaleyraLogin(String kaleyraUserId) async {
//     dynamic result;
...
//
//     print("kaleyraUserId : $kaleyraUserId");
//
...
//           },
//           body: {
//             "user_id": kaleyraUserId
//           }
//       );
//       print("kaleyra response : ${response.body}");
//       if (response.statusCode == 200) {
//         final json = jsonDecode(response.body);
//         result = json['access_token'];
//         print("kaleyra access token : $result");
//         _pref?.setString(GwcApi.kaleyraAccessToken, result);
//       }
//       else {
//         final json = jsonDecode(response.body);
...
//   }
//
//   Future openKaleyraChat(String name, String opponentId,
//       String accessToken) async {
//     const String channelName = "callNative";
//
//
...
//     try {
//       // listenForCall();
//       var result = await channel.invokeMethod("chat_support", m)
//           .whenComplete(() {
//         // _showProgress = false;
//         // notifyListeners();
//       });
//       print("Provider openKaleyraChat $result");
//       // final users = result['users'];
//       // print("users: ${users.runtimeType}");
//       notifyListeners();
//     } on PlatformException catch (e) {
//       print("Provider openKaleyraChat error ${e.message}");
...
// //     print("chatUser : $userName");
// //     bool isLogin;
// //     try {
// //       QBLoginResult result =
// //           await QB.auth.login(userName, AppConfig.QB_DEFAULT_PASSWORD);
...
// //       _pref!.setInt(AppConfig.GET_QB_SESSION,
// //           DateTime.parse(_qbSession!.expirationDate!).millisecondsSinceEpoch);
// //       print("login success..");
// //     } on PlatformException catch (e) {
...
// //         print(
// //             "called  ${int.parse(_pref!.getString(AppConfig.QB_CURRENT_USERID)!)} ${_localUserId}");
...
// //   }
// //
// //   void userIsOnline(String userChatId) async {
// //     try {
// //       await QB.chat.pingUser(
// //         int.parse(userChatId),
// //       );
// //     } on PlatformException catch (e) {
// //       print(e);
// //     }
...
// //       await QB.events
// //           .create(eventType, notificationEventType, senderId, payload,
// //               pushType: pushType)
// //           .then((value) {
...
// //
// //     return await QB.chat.getDialogMessages(dialogId,
...
// //     }
// //     try {
// //       _newMessageSubscription = await QB.chat.subscribeChatEvent(
...
// //         print(
// //             'element.qbMessage.attachments!.first!.url!: ${element.qbMessage.attachments!.first!.id}');
// //       }
// //     });
// //     loadMessages(dialogId);
// //     notifyListeners();
...
// //     qbMessage.senderId = (_localUserId == null)
// //         ? int.parse(_pref!.getString(AppConfig.QB_CURRENT_USERID)!)
// //         : _localUserId;
// //
// //     try {
...
// //           QBChatEvents.MESSAGE_DELIVERED, _processMessageDeliveredEvent,
// //           onErrorMethod: (error) {
...
// //     }
// //     try {
// //       _readMessageSubscription = await QB.chat.subscribeChatEvent(
...
// //     }
// //     try {
// //       _userTypingSubscription = await QB.chat.subscribeChatEvent(
...
// //     }
// //     try {
// //       _userStopTypingSubscription = await QB.chat.subscribeChatEvent(
